      ...
      <div className="main">
        ...
        <div className="btns">
          ...
          <div className="comments">
            <svg className="comments_svg" viewBox="-405.9 238 56.3 54.8" 
            // title="Comment"
            ><path d="M-391 291.4c0 1.5 1.2 1.7 1.9 1.2 1.8-1.6 15.9-14.6 15.9-14.6h19.3c3.8 0 4.4-.8 4.4-4.5v-31.1c0-3.7-.8-4.5-4.4-4.5h-47.4c-3.6 0-4.4.9-4.4 4.5v31.1c0 3.7.7 4.4 4.4 4.4h10.4v13.5z" /></svg><span className="comments_text">12</span>
          </div>
          <div className="views">
            <svg className="views_svg" viewBox="0 0 30.5 16.5"
            //  title="Views"
             ><path d="M15.3 0C8.9 0 3.3 3.3 0 8.3c3.3 5 8.9 8.3 15.3 8.3s12-3.3 15.3-8.3C27.3 3.3 21.7 0 15.3 0zm0 14.5c-3.4 0-6.2-2.8-6.2-6.2C9 4.8 11.8 2 15.3 2c3.4 0 6.2 2.8 6.2 6.2 0 3.5-2.8 6.3-6.2 6.3z" /></svg><span className="views_text">332</span>
          </div>
        </div>
      </div>
    </StyledWrapper>
